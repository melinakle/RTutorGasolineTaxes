...
---
title: Problem Set Gasoline_Taxes
output: 
  html_document: 
    keep_md: yes
    toc: yes
...
```{r "4_23",fig.width=8.5, fig.height=6}
library(forcats)
...
```{r "4_24",fig.width=10, fig.height=6}
# ___
...
```{r "5_30",fig.width=16, fig.height=7}
library(choroplethr)
...
```{r "5_31",fig.width=16, fig.height=7}
...
```{r "7_45",optional=TRUE, eval=FALSE}
...
```{r "7_47",optional=TRUE, eval=FALSE}
...
- Consumers react more strongly to the increase of the gasoline tax. [x]
...
- The tax elasticity increases with income. [x]
...
- decreases the state gasoline tax by 0.167$. [x]
...
```{r "14_79",fig.width=10, fig.heigth=5}
